    ...
    function adicionar(){
        ...
        if ($this->form_validation->run('os') == false) {
           $this->data['custom_error'] = (validation_errors() ? true : false);
            ...
            $dataPronto = $this->input->post('dataPronto');
            ...
            try {
                ...
                $dataPronto = explode('/', $dataPronto);
                $dataPronto = $dataPronto[2].'-'.$dataPronto[1].'-'.$dataPronto[0];
            ...
            $data = array(
                ...
                'equipamentos_id' => $this->input->post('equipamentos_id'),//set_value('idCliente'),
                ...
                'prioridade' => set_value('prioridade'),
                'acessorios' => set_value('acessorios'),
                'faturado' => 0
            );
