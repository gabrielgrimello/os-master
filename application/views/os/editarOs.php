            ...
            <div class="widget-content nopadding">
                ...
                <div class="span12" id="divProdutosServicos" style=" margin-left: 0">
                    <ul class="nav nav-tabs">
                        ...
                        <!--<li id="tabOutros"><a href="#tab4" data-toggle="tab">Outros</a></li>-->
                    ...
                    <div class="tab-content">
                            ...
                            <div class="span12" id="divCadastrarOs">
                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <h3>#Ordem de Serviço: <?php echo $result->idOs ?></h3>
                                        ...
                                        <div class="span2">
                                            ...
                                            <select class="span12" name="prioridade" id="prioridade" value="">
                                                <option <?php if($result->prioridade == 'Baixa'){echo 'selected';} ?> value="Baixa">Baixa</option>
                                                <option <?php if($result->prioridade == 'Normal'){echo 'selected';} ?> value="Normal">Normal</option>
                                                <option <?php if($result->prioridade == 'Urgente'){echo 'selected';} ?> value="Urgente">Urgente</option>
                                                <option <?php if($result->prioridade == 'Emergencial'){echo 'selected';} ?> value="Emergencial">Emergêncial</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span2">
                                            ...
                                            <input id="dataPronto" class="span12 datepicker" type="text" name="dataPronto" value="<?php echo date('d/m/Y', strtotime($result->dataPronto)); ?>"  />
                                        </div>
                                        <div class="span2">
                                        ...
                                        <div class="span2">
                                            ...
                                            <select class="span12" name="garantia" id="garantia" value="">
                                                <option <?php if($result->garantia == 'Sim'){echo 'selected';} ?> value="Sim">Sim</option>
                                                <option <?php if($result->garantia == 'Não'){echo 'selected';} ?> value="Não">Não</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span6">
                                            ...
                                            <input id="equipamento" class="span12" type="text" name="equipamento" value="<?php echo $result->serie ?>"  />
                                        ...
                                        <div class="span3">
                                            ...
                                            <input id="marca" class="span12" type="text" name="marca" value="<?php echo $result->serie ?>"  />
                                        </div>
                                        <div class="span3">
                                            <label for="modelo">Modelo<span class="required">*</span></label>
                                            <input id="modelo" class="span12" type="text" name="modelo" value="<?php echo $result->serie ?>"  />
                                        </div>
                                    </div>
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span6">
                                            ...
                                            <input id="serie" type="text" class="span12" name="serie" value="<?php echo $result->serie ?>"  />
                                            <br>
                                            <br>
                                        ...
                                        <div class="span6">
                                            ...
                                            <textarea class="span12" name="acessorios" id="acessorios" cols="30" rows="5"><?php echo $result->acessorios ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span12">
                                            ...
                                            <textarea class="span12" name="laudoTecnico" id="laudo" cols="30" rows="5"><?php echo $result->laudoTecnico ?></textarea>
                                        </div>
                        ...
                        <div class="tab-pane active" id="tab4">
                            ...
                            <div class="span12" style="padding: 1%; margin-left: 0">
                                <div class="span12 well" style="padding: 1%; margin-left: 0">
                                    <form action="<?php echo current_url(); ?>" method="post" id="formOutros">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span6" style="margin-left: 0">
                                            ...
                                            <label for="osTerceirizada">OS Terceirizada<span class="required">*</span></label>
                                            <input id="osTerceirizada" class="span12" type="text" name="osTerceirizada" value="<?php echo $result->nome ?>"  />
                                           
                                        </div>
                                        <div class="span6">
                                            <label for="acompTerceirizada">Acompanhamento</label>
                                            <textarea class="span12" name="acompTerceirizada" id="acompTerceirizada" cols="30" rows="5"><?php echo $result->defeito?></textarea>
                                        </div>
                                    </div>
